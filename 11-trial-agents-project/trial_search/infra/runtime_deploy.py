"""Build trial_search's container, push to ECR, and create/update its
AgentCore Runtime. Identical structure to trial_graph/infra/runtime_deploy.py
— see that file's own docstring for the full reasoning (arm64 platform
requirement, idempotent create-or-update, why buildx not plain build).
"""
import subprocess
import time
...
REPO_NAME = "trial-search-agent"
RUNTIME_NAME = "trial_search"
