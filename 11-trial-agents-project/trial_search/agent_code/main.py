"""trial_search's A2A server entrypoint — same structure as
trial_graph/agent_code/main.py; see that file's own module docstring
for the full reasoning behind instrumentation order, port 9000 (not
8080), and why /ping needs no separate implementation here.
"""
...
from trial_search.core import orchestrate
from trial_search.schemas import TrialSearchResponse
